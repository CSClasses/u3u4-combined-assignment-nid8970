...
class ViewController: UIViewController,UITableViewDataSource,UITextFieldDelegate {
    ...
    let mode2 = "search"
    let miss = "Not Found"
    let miss2 = "Enter positive numbers!"
    var mode: String = ""
    private var movies: [String] = []
    var result_list: [String] = []
    //helping functions for efficiency
    func ClearStartPage() {//function that help display and search button to clear the start page
        //hide title,button1,button2
        b1.isHidden = true
        b3.isHidden = true
        l1.isHidden = true
    }
    func HidetoReturn() {//function for back buttons

...
class ViewController: UIViewController {
    ...
    let ro = "rock"
    let pa = "paper"
    var cardlist: [UIButton] = []//setting up variables
    ...
    func setCardPosition(x: Int,y: Int){
    ...
    func shufflecards(arr:[String]) -> [String] {
    ...
    func clicked(ord: Int){//set the choosen card as flipped and change the picture
    ...
    func win(){//if the user wins
        l2.text = "You win!"
        game = false//game is over, so cards cannot be clicked
        l2.isHidden = false
        b4.isHidden = false
    }
    func lose(){//if the user loses
        l2.text = "You Lose!"
        game = false//game is over, so cards cannot be clicked
        l2.isHidden = false
        b4.isHidden = false
    }
    func draw(){//if draw, continue

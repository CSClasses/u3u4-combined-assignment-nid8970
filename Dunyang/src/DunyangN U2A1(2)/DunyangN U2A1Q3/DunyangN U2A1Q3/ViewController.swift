...
class ViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    //setting upvariables
    @objc var mylist: [String] = []
    @objc var yourlist: [String] = []
    @objc var result_list: [String] = []
    @objc var searched: [String] = []
    @objc var compared: [String] = []
    @objc var selectedRow = -1
    @objc var uping = false
    @objc var downing = false
    @objc var mode: String = ""
    @objc let mode1 = "mylist"
    @objc let mode2 = "yourlist"
    @objc var searching = false
    @objc var comparing = false
    ...
    @objc func update(mode: String) {//update the list to the edited list
        if mode == mode1{
            mylist = result_list
        }
        else if mode == mode2 {
